...
``` bash
 ...
 INSERT INTO `admins` (`adminID`, `firstname`, `lastname`, `email`, `password`, `created_at`, `updated_at`, `deleted_at`, `isAdmin`) VALUES (NULL, 'admin firstname', 'admin lastname', 'adminemail@example.com', 'hashedpasswordfromyourlarvelapp', NOW(), NOW(), NULL, '1');
```
